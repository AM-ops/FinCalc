# Generated by Django 3.1 on 2020-11-03 14:04
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(default='Installment for Constant Annuity with Interest Paid in Advance', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('answer', models.DecimalField(decimal_places=5, default=0, max_digits=10)),
                ('description', models.CharField(default='', max_length=50)),
                ('type', models.CharField(default='Initial Investment for Constant Annuity with Interest Paid in Advance', max_length=50)),
                ('user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
